...
$TARGET_EMAIL = array(EMAIL_NAME."@bytherart\.net$",
		"^techwiz@techwizworld\.net$",
		"^Ibelieve54@verizon\.net$");

			/* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","techwiz@techwizworld.net");
